...
This is a simple, but an actually practical app for both Android and desktop. It's built on top of the [HelloFXML](https://github.com/makingthematrix/scalaonandroid/tree/main/HelloFXML) example. GUI is based on [a JavaFX tutorial](https://www.youtube.com/watch?v=p5ifU9kkp6g) by Kody Simpson and consists of the main view made in Scene Builder and a history dialog that pops up after clicking a button. The logic is written by me from scratch.
...
The Android APK: [link](https://drive.google.com/file/d/1kxTqYLqF89YwtVdbyixOA5pYmyGUY6ZY/view?usp=sharing)
